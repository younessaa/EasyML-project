        ...
        >
          <div className='container-md p-2'>
                <div className={styles.bgDeterm}>
                    ...
                    <p className={styles.text1}>According to IBM :<a className={styles.machineLearningForDummiesPDF} href='https://www.ibm.com/downloads/cas/GB8ZMQZ3' target='_blank' >Machine Learning for dummies.</a> </p>
