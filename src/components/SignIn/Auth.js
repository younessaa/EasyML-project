        ...
        <div className="container text-center">
            <div className="row p-2">
                ...
                <div className="col-sm-7">
                    {/* <button style={{backgroundColor:"white" , border:"none" , float: "right" ,marginTop:"50px"}} onClick={switchMode}>  
                        {isSingup ? "already have account? Sign In" : "Don't have an account? Sign Up"}
                    </button> */}
